...
First we evaluate nestedness with one of the most widely used nestedness metrics, weighted nestedness (NODF).
...
Both locations have a similar nestedness to the one that is expected by chance (P value > 0.05) when 1000 simulations are considered with a reshuffle of the organization of the original networks for each location.
