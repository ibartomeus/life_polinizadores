...
### \textcolor{gray}{2. Network structure}
...
In this section, we describe the plant-pollinator networks by location and year by evaluating their levels of specialization (H2'), connectance, nestedness, and robustness. Network specialization indicates how selective the species are at the network level, while connectance refers to the number of links compared to all possible links. Both metrics were calculated using the _bipartite_ package [@dormann2008]. Nestedness describes how well the interactions of specialist species are subsets of those of generalist species, while robustness indicates how fragile the networks are to the removal of plant species. Overall, these metrics summarize potentially relevant aspects of the structure of plant-pollinator networks.

To be able to compare nestedness across networks, we used a normalised metric (NODFc) that is independent of network size [@song2017]. This was implemented using the _Maxnodf_ package [@hoeppke2021]. Finally, we calculated robustness by using xxxx [REF].


**Cantavieja**

Cantavieja had `r can_2021$n_pollinators` pollinators and `r can_2021$n_plants` plant species in 2021 and `r can_2024$n_pollinators` pollinators and `r can_2024$n_plants` plants in 2024. The total number of recorded interactions was `r can_2021_int$Interactions` in 2021 and `r can_2024_int$Interactions` in 2024. The level of network specialization was slightly higher in 2021 (H2' = `r round(can_net_2021$H2,2)` than in 2024 (H2' = `r round(can_net_2024$H2,2)`), while connectance was notably higher in 2024 (C = `r round(can_net_2024$Connectance,2)`) than in 2021 (C = `r round(can_net_2021$Connectance,2)`).

**Ejea de los Caballeros**

Ejea de los Caballeros had `r eje_2021$n_pollinators` pollinators and `r eje_2021$n_plants` plant species in 2021 and `r eje_2024$n_plants` pollinators and `r eje_2024$n_plants` plants in 2024. The total number of recorded interactions was `r eje_2021_int$Interactions` in 2021 and `r eje_2024_int$Interactions` in 2024.  The level of network specialization was slightly higher in 2021 (H2' = `r round(eje_net_2021$H2,2)` than in 2024 (H2' = `r round(eje_net_2024$H2,2)`), while connectance was also slightly higher in 2024 (C = `r round(eje_net_2024$Connectance,2)`) than in 2021 (C = `r round(eje_net_2021$Connectance,2)`).
...
#Now compute nestedness and prepare graph C
