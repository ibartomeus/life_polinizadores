...
## Index
- **Objectives**: The goals of this report.
- **Field Sampling**: Methods used for data collection.
- **Species and Interactions**: Comparison of species and interactions using rarefaction and elemental descriptors.
- **Network Descriptors and Structure**: Analysis of the structural differences between the communities.
- **Conclusion**: Final overview based on the results.
...
The objective of this report is to describe the differences between two plant-pollinator communities located in Cantavieja and Ejea de los Caballeros before and after restoration has taken place. The effect of restoration on these two plant-pollinator communities was evaluated by comparing species richness, the number of unique interactions and main aspects of network structure across sampling years.
...
```{r echo=FALSE, out.width='80%',fig.align='center',fig.cap="\\textbf{Figure 1.} Cantavieja (left) and Ejea de los Caballeros (right) locations with the different sampling plots indicated with an orange square plus the plot identifier. The position of the bee hives is shown with a white cross for both locations."}
...
- Comparison of degree distributions? Larger tail may indicate a higher number of distinct species?

- Connectance

- Selectiveness or network specialization?

## Network descriptors and structure
