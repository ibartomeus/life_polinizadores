...
Third, the rarefied accumulation curve of unique interactions was calculated for each location and year. Note that _Apis mellifera_ was excluded, as their individuals do not directly respond to the applied restoration practices. An example of unique interaction is the visit of _Amegilla quadrifasciata_ on _Eryngium_campestre_, which was observed in both locations. Here, we observed similar patterns to the ones observed for the accumulation curve of pollinator species, where cantavieja shows little differences between years but Ejea shows notably more unique interactions between a plant and a pollinator for 2024.


```{r echo=F, fig.align='center', message=FALSE, warning=FALSE, out.width="85%", fig.width=10, fig.cap="\\textbf{Figure 4.}"}
