...
In this section, we describe the plant-pollinator networks by location and year and evaluate their level of specialization (H2') and connectance using the bipartite package [@dormann2008].
