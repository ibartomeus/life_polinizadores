...
```{r echo=F, fig.align='center', message=FALSE, warning=FALSE, dpi=300, out.width="80%"}
...
canta_table %>%
  kbl("latex",escape=FALSE,col.names = c("\\normalfont{Plants species}", "Frequency"),caption = "\\textbf{Table S1.} Frequency of observed interactions with each plant species in Cantavieja") %>%
  kable_styling(bootstrap_options = "striped", full_width = F, position = "center") %>%
  column_spec(1, italic = T)

#Plot table location 2
ejea_table %>%
  kbl("latex",escape=FALSE,col.names = c("\\normalfont{Plants species}", "Frequency"),caption = "\\textbf{Table S1.} Frequency of observed interactions with each plant species in Ejea de los Caballeros") %>%
  kable_styling(bootstrap_options = "striped", full_width = F, position = "center") %>%
  column_spec(1, italic = T)
